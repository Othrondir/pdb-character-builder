export const shellCopyEs = {
  ...
  feats: {
    ...
    searchAriaLabel: 'Buscar dotes por nombre, mínimo 3 caracteres',
    searchPlaceholder: 'Buscar dotes (mín. 3 caracteres)...',
  ...
  stepper: {
    ...
    equipmentSimulation: {
      armorClassLabel: (value: number) => `CA ${value}`,
      armorType: 'Tipo de Armadura',
      cancel: 'Cancelar',
      level12: 'Simular Equipo nivel 12',
      level16: 'Simular Equipo nivel 16',
      shieldMedium: 'Escudo Mediano',
