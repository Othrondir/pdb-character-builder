...
**Coverage at close:** 37/37 active satisfied; 5 descoped (CHAR-03 + MAGI-01..04)
**Audit:** `.planning/milestones/v1.0-MILESTONE-AUDIT.md`

> Frozen snapshot at v1.0 milestone close. Next-milestone requirements live in `.planning/REQUIREMENTS.md` (regenerated via `/gsd-new-milestone`).
